...
(print
  "get-legitimate-children result:"
  (get-legitimate-children DEBUG-EV))

(print
  "get-illegitimate-children result:"
  (get-illegitimate-children DEBUG-EV))

(print "get-flags result:" (get-flags DEBUG-EV))

(print
  "contains no-will?"
  (contains? (get-flags DEBUG-EV) 'no-will))
