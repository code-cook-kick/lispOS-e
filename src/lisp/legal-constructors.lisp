...
; Returns: (event type <props...>)
; Example: (event.make 'death (list "person" "Pedro" "date" "2024-01-01"))
(define event.make (lambda (type props)
  (cons 'event (cons type props))))
...
; Returns: (fact pred args props)
; Example: (fact.make 'heir-share (list "Pedro" "Maria") (list "share" "1/2"))
...
(define invalid-fact (list 'not-fact 'heir-share))
(print "fact.valid? invalid-fact =>" (fact.valid? invalid-fact))
(print "")

; =============================================================================
; ADDITIONAL LEGAL EXAMPLES
; =============================================================================
...
(print "Contract subject:" (event.get contract-event "subject"))
...
(print "")
(print "Data Model:")
(print "  Events: (event <type> <key1> <val1> <key2> <val2> ...)")
