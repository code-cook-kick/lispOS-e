; Etherney Lisp Machine - Initial Test Script
; This script demonstrates the basic capabilities of the interpreter
...
(print "  'hello =>" 'hello)
(print "  '(+ 1 2) =>" '(+ 1 2))
(print "  '(nested (list (structure))) =>" '(nested (list (structure))))
(print "")
...
(print "  Simple list: '(apple banana cherry) =>" '(apple banana cherry))
(print "  Nested list: '((x 1) (y 2) (z 3)) =>" '((x 1) (y 2) (z 3)))
(print "  Mixed types: '(1 \"hello\" symbol #t) =>" '(1 "hello" symbol #t))
(print "")

; Test computational examples
...
(print "  √((x₂-x₁)² + (y₂-y₁)²) components where x₁=1, y₁=1, x₂=4, y₂=5")
(print "  (+ (* (- 4 1) (- 4 1)) (* (- 5 1) (- 5 1))) =>" (+ (* (- 4 1) (- 4 1)) (* (- 5 1) (- 5 1))))
(print "")
...
; Test error resilience (these should work)
(print "12. Testing Valid Edge Cases:")
(print "  Very small numbers: (+ 0.001 0.002) =>" (+ 0.001 0.002))
